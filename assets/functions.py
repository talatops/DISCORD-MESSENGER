...
def SuccessEmbed(title, description):
    return discord.Embed(title=":ballot_box_with_check: "+title, description=description, color=discord.Color.green())

def ErrorEmbed(title, description):
    return discord.Embed(title=":x: "+title, description=description, color=discord.Color.from_rgb(255,0,0))
